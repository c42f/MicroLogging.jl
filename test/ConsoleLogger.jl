...
import MicroLogging.default_metafmt
...
@testset "ConsoleLogger" begin
    ...
    # Basic colorization test.  Terminal color code ordering is irrelevant but
    # changed going from 0.6 to 0.7 and the test string depends on it.
    if VERSION >= v"0.7"
        @test genmsg("line1\nline2", color=true) ==
        """
        ...
        @test genmsg("line1\nline2", color=true) ==
        """
        \e[1m\e[36m┌ \e[39m\e[22m\e[1m\e[36mPREFIX \e[39m\e[22mline1
        \e[1m\e[36m│ \e[39m\e[22mline2
        \e[1m\e[36m└ \e[39m\e[22m\e[90mSUFFIX\e[39m
        """
    end
